...
const SemanaSanta = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between min-h-screen px-6 md:px-16 py-12 bg-gradient-to-r from-red-700 to-purple-700 text-white">
      {/* Left section */}
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-end items-end ">
        <img
          ...
          alt="Semana Santa"
          className="md:w-3/4 w-full h-full md:h-[550px] object-cover  rounded-xl md:rounded-bl-[100px] rounded-bl-[50px]"
        />
      </div>
    </section>
  );
